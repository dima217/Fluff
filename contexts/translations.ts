export const translations = {
  ru: {
    ...
    profile: {
      ...
      personalCalculatedIntake: "Персональная расчётная норма",
      recalculate: "Пересчитать",
      useAsDailyIntake: "Установить как норму",
    ...
    settings: {
      ...
      notificationAccessFooter:
        "Разрешите приложению отправлять уведомления об обновлениях, активности и т. д.",
      preferences: "Настройки",
      localTime: "Местное время",
      publicationAccess: "Доступ к публикации",
      publishRecipes: "Публиковать рецепты",
      publicationAccessFooter:
        "Разрешить приложению спрашивать о публикации моих рецептов",
      healthTracking: "Отслеживание здоровья",
      trackNutrients: "Отслеживать нутриенты",
    ...
    auth: {
      ...
      googleSignInWebOnly: "Доступно в мобильной сборке (Android / iOS).",
      googleSignInConfigError:
        "Задайте expo.extra.googleWebClientId в app.json (Web client ID из Google Cloud Console).",
      googleSignInNoToken:
        "Google не вернул idToken. Проверьте Web client ID в GoogleSignin.configure.",
    ...
    recipe: {
      ...
      gramsRequired: "Укажите количество продукта",
      gramsUnit: "г",
      pcsUnit: "шт",
      selectUnit: "Единица измерения",
      selectedProducts: "Выбранные продукты",
      customProducts: "Свои ингредиенты",
      noProductsFound: "Продукты не найдены",
      customProductNutrition: "Пищевая ценность",
      customProductNutritionHint: "Укажите КБЖУ на весь добавляемый объём (необязательно)",
      caloriesLabel: "Калории (ккал)",
      proteinsLabel: "Белки (г)",
      fatsLabel: "Жиры (г)",
      carbsLabel: "Углеводы (г)",
      nutritionExceedsWeight: "Сумма БЖУ не может превышать вес ингредиента",
      macroExceedsWeight: "Значение не может превышать вес ингредиента",
      caloriesExceedsMax: "Максимум ~9 ккал/г (для жиров)",
      base: "Основное",
      baseHint:
      ...
      cookTimeHint: "Укажите, сколько времени занимает приготовление блюда",
      cookHours: "Часы",
      cookMinutes: "Минуты",
      cookHoursPlaceholder: "0",
      cookMinutesPlaceholder: "30",
      createdAt: "Дата создания",
      createdAtHint: "Когда был создан рецепт",
      createdDatePlaceholder: "ГГГГ-ММ-ДД",
      ...
      addToCheatMeal: "Добавить в читмил",
      deleteRecipeTitle: "Удалить рецепт?",
      deleteRecipeMessage: "Это действие нельзя отменить.",
      deleteRecipeError: "Не удалось удалить рецепт",
      createSuccess: "Рецепт успешно создан",
      createError: "Не удалось создать рецепт",
      updateSuccess: "Рецепт обновлён",
      updateError: "Не удалось обновить рецепт",
      review: "Просмотр",
      ...
      validation: {
        ...
        createdDateInvalid: "Укажите дату в формате ГГГГ-ММ-ДД",
        cookTimeRequired: "Укажите время приготовления",
    ...
    nutrition: {
      ...
      nutrientDetailsSubtitle: "Прогресс за сегодня относительно дневной нормы",
    ...
    health: {
      ...
      portionGramsMessage: "Укажите сколько грамм вы съедите",
      portionGramsPlaceholder: "Например: 300",
      macros: "Нутриенты",
      proteins: "Белки",
      proteinsPlaceholder: "г белка",
      fats: "Жиры",
      fatsPlaceholder: "г жиров",
      carbs: "Углеводы",
      carbsPlaceholder: "г углеводов",
    },
  ...
  be: {
    ...
    profile: {
      ...
      personalCalculatedIntake: "Персанальная разліковая норма",
      recalculate: "Пералічыць",
      useAsDailyIntake: "Выкарыстаць як дзённую норму",
      personalInfo: "Асабістыя даныя",
      gender: "Пол",
      age: "Узрост",
      height: "Рост",
      weight: "Вага",
    ...
    settings: {
      notificationAccess: "Доступ да апавяшчэнняў",
      turnOnNotifications: "Уключыць апавяшчэнні",
      notificationAccessFooter:
        "Дазвольце дадатку адпраўляць апавяшчэнні пра абнаўленні, актыўнасць і г.д.",
      preferences: "Налады",
      localTime: "Мясцовы час",
      publicationAccess: "Доступ да публікацыі",
      publishRecipes: "Публікаваць рэцэпты",
      publicationAccessFooter:
        "Дазволіць дадатку пытаць пра публікацыю маіх рэцэптаў",
      healthTracking: "Адсочванне здароўя",
      trackNutrients: "Адсочваць нутрыенты",
      nutrientTrackingFooter:
    ...
    auth: {
      ...
      googleSignInTitle: "Google Sign-In",
      googleSignInWebOnly: "Даступна ў мабільнай зборцы (Android / iOS).",
      googleSignInConfigError:
        "Задайце expo.extra.googleWebClientId у app.json (Web client ID з Google Cloud Console).",
      googleSignInNoToken:
        "Google не вярнуў idToken. Праверце Web client ID у GoogleSignin.configure.",
      googleSignInError: "Памылка ўваходу праз Google",
    ...
    health: {
      ...
      portionGramsMessage: "Укажыце колькі грамаў вы з'ясце",
      portionGramsPlaceholder: "Напрыклад: 300",
      macros: "Нутрыенты",
      proteins: "Бялкі",
      proteinsPlaceholder: "г бялку",
      fats: "Тлушчы",
      fatsPlaceholder: "г тлушчаў",
      carbs: "Вугляводы",
      carbsPlaceholder: "г вугляводаў",
    },
    editDailyCalorieGoalModal: {
    ...
    recipe: {
      ...
      gramsRequired: "Укажыце колькасць прадукту",
      gramsUnit: "г",
      pcsUnit: "шт",
      selectUnit: "Адзінка вымярэння",
      selectedProducts: "Выбраныя прадукты",
      customProductNutrition: "Харчовая каштоўнасць",
      customProductNutritionHint: "Укажыце КБЖУ на ўвесь аб'ём (неабавязкова)",
      caloriesLabel: "Калорыі (ккал)",
      proteinsLabel: "Бялкі (г)",
      fatsLabel: "Тлушчы (г)",
      carbsLabel: "Вугляводы (г)",
      nutritionExceedsWeight: "Сума БЖУ не можа перавышаць вагу інгрэдыента",
      macroExceedsWeight: "Значэнне не можа перавышаць вагу інгрэдыента",
      caloriesExceedsMax: "Максімум ~9 ккал/г (для тлушчаў)",
      ...
      cookTime: "Час прыгатавання",
      cookTimeHint: "Укажыце, колькі часу займае прыгатаванне стравы",
      cookHours: "Гадзіны",
      cookMinutes: "Хвіліны",
      cookHoursPlaceholder: "0",
      cookMinutesPlaceholder: "30",
      createdAt: "Дата стварэння",
      createdAtHint: "Калі быў створаны рэцэпт",
      createdDatePlaceholder: "ГГГГ-ММ-ДД",
      ...
      addToCheatMeal: "Дадаць у чытміл",
      deleteRecipeTitle: "Выдаліць рэцэпт?",
      deleteRecipeMessage: "Гэта дзеянне нельга адмяніць.",
      deleteRecipeError: "Не ўдалося выдаліць рэцэпт",
      createSuccess: "Рэцэпт паспяхова створаны",
      createError: "Не ўдалося стварыць рэцэпт",
      updateSuccess: "Рэцэпт абноўлены",
      updateError: "Не ўдалося абнавіць рэцэпт",
      review: "Прагляд",
      ...
      validation: {
        ...
        createdDateInvalid: "Укажыце дату ў фармаце ГГГГ-ММ-ДД",
        cookTimeRequired: "Укажыце час прыгатавання",
    ...
    nutrition: {
      ...
      nutrientDetailsSubtitle: "Прагрес за сёня адносна дзённай нормы",
  ...
  en: {
    ...
    profile: {
      ...
      personalCalculatedIntake: "Personal Calculated Intake",
      recalculate: "Recalculate",
      useAsDailyIntake: "Set as daily intake",
    ...
    settings: {
      ...
      notificationAccessFooter:
        "Allow app to notify you about updates, activity, etc.",
      preferences: "Preferences",
      localTime: "Local Time",
      publicationAccess: "Publication Access",
      publishRecipes: "Publish Recipes",
      publicationAccessFooter:
        "Allow app to ask me about publishing my recipes",
      healthTracking: "Health Tracking",
      trackNutrients: "Track Nutrients",
      nutrientTrackingFooter:
    ...
    auth: {
      ...
      googleSignInTitle: "Google Sign-In",
      googleSignInWebOnly: "Available in the mobile build (Android / iOS).",
      googleSignInConfigError:
        "Set expo.extra.googleWebClientId in app.json (Web client ID from Google Cloud Console).",
      googleSignInNoToken:
        "Google did not return an idToken. Check the Web client ID in GoogleSignin.configure.",
    ...
    recipe: {
      ...
      gramsRequired: "Enter the product amount",
      gramsUnit: "g",
      pcsUnit: "pcs",
      ...
      customProductNutrition: "Nutritional value",
      customProductNutritionHint: "Specify nutrition for the total amount (optional)",
      caloriesLabel: "Calories (kcal)",
      proteinsLabel: "Protein (g)",
      fatsLabel: "Fat (g)",
      carbsLabel: "Carbs (g)",
      nutritionExceedsWeight: "Sum of macros cannot exceed ingredient weight",
      macroExceedsWeight: "Value cannot exceed ingredient weight",
      caloriesExceedsMax: "Max ~9 kcal/g (for fat)",
      base: "Base",
      baseHint:
      ...
      cookTimeHint: "How long it takes to prepare the dish",
      cookHours: "Hours",
      cookMinutes: "Minutes",
      cookHoursPlaceholder: "0",
      cookMinutesPlaceholder: "30",
      createdAt: "Creation date",
      createdAtHint: "When the recipe was created",
      createdDatePlaceholder: "YYYY-MM-DD",
      ...
      addToCheatMeal: "Add to cheat meal",
      ...
      validation: {
        ...
        createdDateInvalid: "Use date format YYYY-MM-DD",
        cookTimeRequired: "Enter cooking time",
    ...
    nutrition: {
      ...
      nutrientDetailsSubtitle: "Today's progress against your daily norm",
    ...
    health: {
      ...
      portionGramsMessage: "Enter how many grams you will eat",
      portionGramsPlaceholder: "Example: 300",
      macros: "Nutrients",
      proteins: "Proteins",
      proteinsPlaceholder: "g of protein",
      fats: "Fats",
      fatsPlaceholder: "g of fat",
      carbs: "Carbs",
      carbsPlaceholder: "g of carbs",
    },
    editDailyCalorieGoalModal: {
