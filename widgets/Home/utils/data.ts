...
export const getRecipesData = (
  recipesResponse: RecipeResponse[] | undefined
) => {
...
export const getProductsData = (
  productsResponse: ProductResponse[] | { data: ProductResponse[] } | undefined
) => {
...
export const normalizeRecipes = (
  recipes: RecipeResponse[] | { data: RecipeResponse[] } | undefined
): RecipeResponse[] => {
  if (!recipes) return [];
